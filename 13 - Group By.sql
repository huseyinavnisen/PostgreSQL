-- GROUP BY --
/*
GROUP BY cümleciği bir SELECT ifaseinde satırları, sütunları değrlerine göre
--özet olarak gruplamak için kullanılır.
GROUP BY  her grup başına Satır Döndürür.
...
-- ve isime göre ters sırada listeyen sorguyu yazınız.
...
select ulke, avg (maas)  from personel avg group by ulke
